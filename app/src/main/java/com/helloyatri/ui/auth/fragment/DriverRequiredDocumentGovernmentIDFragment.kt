...
@AndroidEntryPoint
class DriverRequiredDocumentGovernmentIDFragment :
        BaseFragment<AuthDriverCompleteGovernmentIdFragmentBinding>() {

    @Inject
    lateinit var mediaSelectHelper: MediaSelectHelper

    private val driverRequiredDocumentsGovernmentIdDetailsAdapter by lazy {
    ...
    override fun createViewBinding(inflater: LayoutInflater, container: ViewGroup?,
                                   attachToRoot: Boolean): AuthDriverCompleteGovernmentIdFragmentBinding {
        return AuthDriverCompleteGovernmentIdFragmentBinding.inflate(layoutInflater)
    }
    ...
    private fun setUpRecyclerView() = with(binding) {
        recyclerViewDetails.apply {
            adapter = driverRequiredDocumentsGovernmentIdDetailsAdapter
    ...
    private fun setUpClickListener() = with(binding) {
        ...
        buttonSave.setOnClickListener {
            session.isGovernmentIDAdded = true
            navigator.goBack()
        }
    }
