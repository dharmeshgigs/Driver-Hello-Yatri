...
@AndroidEntryPoint
class DriverVehiclePUCFragment : BaseFragment<AuthDriverVehiclePucFragmentBinding>() {

    @Inject
    lateinit var mediaSelectHelper: MediaSelectHelper

    private val driverVehiclePUCDetailsAdapter by lazy {
    ...
    override fun createViewBinding(inflater: LayoutInflater, container: ViewGroup?,
                                   attachToRoot: Boolean): AuthDriverVehiclePucFragmentBinding {
        return AuthDriverVehiclePucFragmentBinding.inflate(layoutInflater)
    }
    ...
    private fun setUpRecyclerView() = with(binding) {
        recyclerViewDetails.apply {
            adapter = driverVehiclePUCDetailsAdapter
    ...
    private fun setUpClickListener() = with(binding) {
        ...
        buttonSave.setOnClickListener {
            session.isVehiclePUCAdded = true
            navigator.goBack()
        }
    }
