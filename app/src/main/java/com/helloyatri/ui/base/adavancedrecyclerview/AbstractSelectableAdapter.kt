...
abstract class AbstractSelectableAdapter<H : SelectableViewHolder<E>, E : AbstractSelectableAdapter.Selectable> : AdvanceRecycleViewAdapter<H, E>, SelectionActionPerformer<E> {
    ...
    val selectedItems: ArrayList<E>
        get() {
            ...
            if (items != null) {
                for (e in items!!) {
                    if (e.isSelected) selectedElements.add(e)
                }
            }
